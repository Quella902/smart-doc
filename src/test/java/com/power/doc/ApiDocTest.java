...
//            SourceCodePath.path().setPath("F:\\Personal\\project\\smart\\src\\main\\java"),
...
//
    ...
    public void testSingleApi() {
        String filePath = "D:\\workspace\\zyfz\\ccue-cciec-platform-branch\\ccue-cciec-dispatch\\ccue-cciec-dispatch-server"
            + "\\src\\main\\java\\ccue\\cciec\\dispatch\\server\\controller\\business\\CoalWashingDayReportBusinessController.java";
        ApiConfig config = new ApiConfig();
        config.setServerUrl("http://localhost:8080");
        // 注释检查模式
        config.setStrict(true);
        ...
        //不指定SourcePaths默认加载代码为项目src/main/java下的
        config.setSourceCodePaths(
            SourceCodePath.path().setDesc("本项目代码").setPath("D:\\workspace\\zyfz\\ccue-cciec-platform-branch\\"
                + "ccue-cciec-dispatch\\ccue-cciec-dispatch-server\\src\\main\\java"),
            SourceCodePath.path().setDesc("本项目代码").setPath("D:\\workspace\\zyfz\\ccue-cciec-platform-branch\\"
                + "ccue-cciec-dispatch\\ccue-cciec-dispatch-api\\src\\main\\java"),
            SourceCodePath.path().setDesc("加载外部项目源码").setPath("D:\\workspace\\zyfz\\ccue-cciec-platform-branch\\"
                + "ccue-cciec-common\\ccue-cciec-common-core\\src\\main\\java"),
            SourceCodePath.path().setDesc("加载外部项目源码").setPath("D:\\workspace\\zyfz\\ccue-cciec-platform-branch\\"
                + "ccue-cciec-common\\ccue-cciec-common-api\\src\\main\\java")
        );
        ApiDocBuilder.buildSingleApiDoc(config, filePath);
